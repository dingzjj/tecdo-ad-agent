...
from agent.third_part.google_play_scraper.utils import nested_lookup
from agent.third_part.google_play_scraper.utils.data_processors import unescape_text
...
class ElementSpecs:
    ...
    SearchResultOnTop = {
        ...
        "price": ElementSpec(
            None, [2, 57, 0, 0, 0, 0, 1, 0, 0], lambda price: (
                price / 1000000) or 0
        ),
